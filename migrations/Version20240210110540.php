 ...
 */
final class Version20240210110540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE invoice (id INT NOT NULL, quotation_id INT DEFAULT NULL, customer_id INT DEFAULT NULL, expires_in DATE DEFAULT NULL, total_with_out_taxe NUMERIC(8, 2) DEFAULT NULL, total NUMERIC(8, 2) DEFAULT NULL, taxe DOUBLE PRECISION DEFAULT NULL, is_valid BOOLEAN DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE invoice_item (id INT NOT NULL, invoice_id INT NOT NULL, product_id INT NOT NULL, discount DOUBLE PRECISION DEFAULT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
